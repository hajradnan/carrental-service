...
error_reporting(0);
// The error reporting function is a built-in PHP function that allows developers to control which and how many errors will be shown in the application
?>
  ...
  <div class="container">
    <div class="page-header_wrap">
      ...
      <ul class="coustom-breadcrumb">
        ...
        <li><a href="http://localhost/carrental/index.php">Home</a></li>
        <li>Car Listing</li>
      </ul>
    </div>
  </div>
...
{  ?>
        <div class="product-listing-m gray-bg">
          ...
          <!-- attaching images for each -->  
          <div class="product-listing-content">
            <h5><a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->BrandName);?> , <?php echo htmlentities($result->VehiclesTitle);?></a></h5>

            <!-- adding details for every car -->
...
<!-- searching mechanism through fuel and brand -->
...
<option value="CNG">CNG</option>
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            ...
            <!-- recently listed cars with their prices per day -->
          </div>
