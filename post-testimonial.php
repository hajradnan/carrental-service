...
if($lastInsertId)
{
$msg="Hello! Your testimonial is submitted successfully";
}
else 
{
...
<section class="user_profile inner_pages">
  <div class="container">
    <div class="user_profile_info gray-bg padding_4x4_40">
      <div class="upload_user_logo"> <img src="assets/images/user-icon.jpg" alt="image">
      </div>

      <div class="dealer_info">
        <!-- showing information of client -->
